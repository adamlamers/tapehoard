...
<div class="flex flex-col gap-8 animate-in fade-in duration-700">
    ...
    <header class="flex justify-between items-center bg-bg-secondary px-8 py-5 rounded-xl border border-border-color shadow-2xl relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <p class="text-[12px] font-bold uppercase tracking-widest text-text-secondary mt-1 opacity-80">
                Operational Intelligence & Fleet Analytics
            </p>
        </div>
    ...
    {#if loading}
        <div class="flex-1 flex flex-col items-center justify-center gap-4 opacity-50">
            ...
            <span class="text-xs font-black uppercase tracking-widest text-text-secondary">Synthesizing Records...</span>
        </div>
    {:else if insights}
        <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <Card class="p-6 bg-bg-secondary border-border-color flex flex-col gap-2">
                    <span class="text-[9px] font-black uppercase tracking-widest text-text-secondary opacity-50">Total Fleet Objects</span>
                    <div class="flex items-center justify-between">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card class="p-8 bg-bg-secondary border-border-color shadow-xl overflow-hidden flex flex-col gap-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-black uppercase tracking-tight text-text-primary">Recursive Risk Mapping</h3>
                ...
                <Card class="p-8 bg-bg-secondary border-border-color shadow-xl flex flex-col gap-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-black uppercase tracking-tight text-text-primary">Thermal Lifecycle Aging</h3>
                ...
                <Card class="p-8 bg-bg-secondary border-border-color shadow-xl flex flex-col gap-8">
                    ...
                    <div class="space-y-2">
                        {#each insights.extensions as ext}
                            <div class="flex items-center gap-4 p-2.5 rounded-lg hover:bg-white/5 transition-colors group">
                                <div class="w-12 text-[10px] font-black uppercase text-text-secondary opacity-60 mono">.{ext.ext}</div>
                                <div class="flex-1 h-2 bg-bg-primary rounded-full overflow-hidden border border-border-color">
                                    <div class="h-full bg-purple-500 transition-all duration-1000" style="width: {(ext.size / insights.summary.total_bytes) * 100}%"></div>
                                </div>
                                <div class="text-right w-24">
                                    <span class="text-[10px] font-black text-text-primary mono">{formatSize(ext.size)}</span>
                                </div>
                            </div>
                        {/each}
                    </div>
                ...
                <Card class="p-8 bg-bg-secondary border-border-color shadow-xl flex flex-col gap-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-text-secondary font-bold uppercase tracking-widest opacity-50">Physical copy distribution across fleet</p>
                        </div>
                    </div>
                            ...
                            <div class={cn(
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <span class="text-[9px] font-bold text-text-secondary uppercase opacity-60">
                                        {red.file_count.toLocaleString()} Fleet Objects
                                    </span>
                                </div>
                                <div class="text-right">
                                    <span class={cn(
