 ...
 */
export const updateSettingsBatch = <ThrowOnError extends boolean = false>(options: Options<UpdateSettingsBatchData, ThrowOnError>) => (options.client ?? client).post<UpdateSettingsBatchResponses, UpdateSettingsBatchErrors, ThrowOnError>({
