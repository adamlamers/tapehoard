 ...
 */
export const listRecoveryQueueRestoresCartGet = <ThrowOnError extends boolean = false>(options?: Options<ListRecoveryQueueRestoresCartGetData, ThrowOnError>) => (options?.client ?? client).get<ListRecoveryQueueRestoresCartGetResponses, unknown, ThrowOnError>({ url: '/restores/cart', ...options });
 ...
 */
export const clearRecoveryQueueRestoresCartClearPost = <ThrowOnError extends boolean = false>(options?: Options<ClearRecoveryQueueRestoresCartClearPostData, ThrowOnError>) => (options?.client ?? client).post<ClearRecoveryQueueRestoresCartClearPostResponses, unknown, ThrowOnError>({ url: '/restores/cart/clear', ...options });
 ...
 */
export const addFileToRecoveryQueueRestoresCartFileIdPost = <ThrowOnError extends boolean = false>(options: Options<AddFileToRecoveryQueueRestoresCartFileIdPostData, ThrowOnError>) => (options.client ?? client).post<AddFileToRecoveryQueueRestoresCartFileIdPostResponses, AddFileToRecoveryQueueRestoresCartFileIdPostErrors, ThrowOnError>({ url: '/restores/cart/{file_id}', ...options });
 ...
 */
export const removeFromRecoveryQueueRestoresCartItemIdDelete = <ThrowOnError extends boolean = false>(options: Options<RemoveFromRecoveryQueueRestoresCartItemIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<RemoveFromRecoveryQueueRestoresCartItemIdDeleteResponses, RemoveFromRecoveryQueueRestoresCartItemIdDeleteErrors, ThrowOnError>({ url: '/restores/cart/{item_id}', ...options });
 ...
 */
export const addDirectoryToRecoveryQueueRestoresCartDirectoryPost = <ThrowOnError extends boolean = false>(options: Options<AddDirectoryToRecoveryQueueRestoresCartDirectoryPostData, ThrowOnError>) => (options.client ?? client).post<AddDirectoryToRecoveryQueueRestoresCartDirectoryPostResponses, AddDirectoryToRecoveryQueueRestoresCartDirectoryPostErrors, ThrowOnError>({
 ...
 */
export const browseRecoveryQueueVirtualFsRestoresCartBrowseGet = <ThrowOnError extends boolean = false>(options?: Options<BrowseRecoveryQueueVirtualFsRestoresCartBrowseGetData, ThrowOnError>) => (options?.client ?? client).get<BrowseRecoveryQueueVirtualFsRestoresCartBrowseGetResponses, BrowseRecoveryQueueVirtualFsRestoresCartBrowseGetErrors, ThrowOnError>({ url: '/restores/cart/browse', ...options });
 ...
 */
export const getRecoveryQueueTreeRestoresCartTreeGet = <ThrowOnError extends boolean = false>(options?: Options<GetRecoveryQueueTreeRestoresCartTreeGetData, ThrowOnError>) => (options?.client ?? client).get<GetRecoveryQueueTreeRestoresCartTreeGetResponses, GetRecoveryQueueTreeRestoresCartTreeGetErrors, ThrowOnError>({ url: '/restores/cart/tree', ...options });
