 ...
 */
export const listStorageFleetInventoryMediaGet = <ThrowOnError extends boolean = false>(options?: Options<ListStorageFleetInventoryMediaGetData, ThrowOnError>) => (options?.client ?? client).get<ListStorageFleetInventoryMediaGetResponses, unknown, ThrowOnError>({ url: '/inventory/media', ...options });
